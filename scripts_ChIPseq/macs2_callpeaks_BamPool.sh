...
macs2 callpeak -t mapped/chip/downsample/EMF2_Rep1.dupmark.sorted.bam mapped/chip/downsample/EMF2_Rep2.dupmark.sorted.bam \
  ...
  --nomodel -g 373128865 \
  --outdir ${macs2_out} -n EMF2_pool
                                                                                                 
awk -F"\t" -v q=${q} 'BEGIN{OFS="\t"} $9>=q {print}' ${macs2_out}/EMF2_pool_peaks.narrowPeak > ${macs2_out}/noMask_qval${q}/EMF2_pool_peaks.narrowPeak                                             
    
bedtools intersect -v -wa \
  -a ${macs2_out}/noMask_qval${q}/EMF2_pool_peaks.narrowPeak \
  -b ${gs_regions} > ${macs2_out}/gsMask_qval${q}/EMF2_pool_peaks.narrowPeak                                             
...
macs2 callpeak -t mapped/chip/downsample/H3K27me3_Rep1.dupmark.sorted.bam mapped/chip/downsample/H3K27me3_Rep2.dupmark.sorted.bam \
  ...
  -f BAMPE --keep-dup auto \
  --nomodel -g 373128865 \
  --outdir ${macs2_out} -n H3K27me3_pool
                                                                                                 
awk -F"\t" -v q=${q} 'BEGIN{OFS="\t"} $9>=q {print}' ${macs2_out}/H3K27me3_pool_peaks.narrowPeak > ${macs2_out}/noMask_qval${q}/H3K27me3_pool_peaks.narrowPeak                                             
    
bedtools intersect -v -wa \
  -a ${macs2_out}/noMask_qval${q}/H3K27me3_pool_peaks.narrowPeak \
  -b ${gs_regions} > ${macs2_out}/gsMask_qval${q}/H3K27me3_pool_peaks.narrowPeak    
